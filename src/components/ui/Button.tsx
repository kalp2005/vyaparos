...
export function Button({
  ...
  const variants = {
    primary:
      'bg-vyapar-600 hover:bg-vyapar-700 text-white focus:ring-vyapar-500 shadow-sm active:scale-[0.98]',
    secondary:
    ...
    outline:
      'border border-slate-300 dark:border-slate-700 bg-transparent hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 focus:ring-slate-400',
    danger:
      'bg-rose-600 hover:bg-rose-700 text-white focus:ring-rose-500 shadow-sm active:scale-[0.98]',
    success:
